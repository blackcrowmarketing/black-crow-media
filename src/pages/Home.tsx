  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-green-500 selection:text-black">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-900/30 border border-green-500/30 text-green-400 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/agency-os" className="w-full sm:w-auto">
                <Button size="lg" className="bg-green-500 hover:bg-green-400 text-black font-bold text-lg px-8 py-6 h-auto w-full shadow-[0_0_20px_rgba(34,197,94,0.5)] transition-all hover:scale-105">
                  Explore Agency OS
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Agency OS */}
            <Link to="/agency-os">
              <Card className="bg-zinc-900 border-zinc-800 hover:border-green-500/50 transition-colors group cursor-pointer h-full">
      ...
      <footer className="py-12 border-t border-zinc-800 text-center text-gray-500">
        <div className="container mx-auto px-4">
          <p className="mb-4">Black Crow Media</p>
